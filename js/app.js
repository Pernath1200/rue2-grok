...
import { registerCallbacks as registerCurrCallbacks, renderDiagram, showIntroSection, showWritingTipsIntroSection, startWritingTipsQuiz, startCourseSection, advanceCourseToNext, startLessonAfterIntro, startPart1, startDiagnostic, startMixedPractice, getCourseIntroSections, openLessonModal } from './curriculum.js';
...
document.getElementById('quizScreen').addEventListener('click', function(e) {
  ...
  if (lessonLink) {
    e.preventDefault();
    openLessonModal(lessonLink.getAttribute('data-topic-id'), lessonLink.getAttribute('data-section-id') || null);
    return;
  }
